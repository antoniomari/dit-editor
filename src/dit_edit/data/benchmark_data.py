...
class BenchmarkExample:
    def __init__(self, image_path: str):
        ...
        self.category = os.path.dirname(image_path).split(os.sep)[
            -1
        ...
        for img_file in all_images:
            if img_file.startswith("bg"):
                ...
                img_file.startswith("fg")
                and img_file.endswith(".jpg")
                and not "mask" in img_file
            ):
                ...
                img_file
                == "alphanoise0.05_timesteps50_QTrue_KTrue_VFalse_taua0.4_taub0.8_guidance3.0_all-layers.png"
            ):
