...
if __name__ == "__main__":
    ...
    SOURCE_PROMPT = "photo of a cute dog puppy"
    TARGET_PROMPT = "photo of a cute kitten with a flower crown"
    ...
    MASK_IMAGE_PATH = "fg01_mask.png" # IMPORTANT: Path to your B/W mask file
